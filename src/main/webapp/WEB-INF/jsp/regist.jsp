...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <h3>欢迎注册</h3>
            <form class="m-t" role="form" action="doRegist">
                ...
                <div class="form-group text-left">
                    <div class="checkbox i-checks">
                            ...
                            <input type="radio" name="usertype" value=0><i></i>教师
                        
                            <input type="radio" name="usertype" value=1 style="margin-left:30px"><i></i>学生
                    </div>
